...
d_inner_hid=256 # 修正: d_inner -> d_inner_hid
d_k=16
d_v=16
...
normalize=normal
loss_lambda=5 # 新增: 辅助损失权重 (参考 smurf_retweet.sh)
...
save_name=retweet_fthp_model_best_${normalize}_lambda_${loss_lambda}
...
# --- 评估命令 ---
load_path_name=./checkpoints/retweet/${save_name}.pth
save_result=./results/retweet/${save_name}_samples
